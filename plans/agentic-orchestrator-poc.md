...
- Markdown prompt documents stored in `prompts/orchestrator/*.md`.
...
3. Prompt and Context Module - `backend/orchestrator/prompts.py`
   - Loads markdown prompt documents from `prompts/orchestrator/`.
...
6. Persistence Layer - `backend/orchestrator/store.py`
...
7. Domain Models - `backend/orchestrator/models.py`
...
- `prompts/orchestrator/problem-understanding.md`
...
- `prompts/orchestrator/plan-generation.md`
...
- `prompts/orchestrator/plan-refinement.md`
...
- `prompts/orchestrator/state-check.md`
...
5. Add runtime configuration in `backend/config.py`.
...
6. Expose a small streaming API in `backend/api/orchestrator.py` and `backend/app.py`.
   - Add:
...
7. Add end-to-end tests in `tests/test_orchestrator_store.py`, `tests/test_orchestrator_engine.py`, and `tests/test_orchestrator_api.py`.
...
8. Update supporting docs in `milestones/PoC.md` and a short implementation note such as `docs/orchestrator-poc.md` if a new docs folder is added.
